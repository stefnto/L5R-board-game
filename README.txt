...
Σε κάθε γύρο ο παίχτης λαμβάνει money=5 το οποίο και αποθηκεύεται. Το temp_money προσδιορίζει το χρήμα που παίρνει ο παίχτης από τα holdings ή το stronghold(γίνονται tapped) στην συνάρτηση Harvest όταν το money του παίχτη δεν επαρκεί για την αγορά ενος province ή
μιας πράσινης κάρτας.Επειδή ακριβώς το temp_money έχει αυτήν την ιδιότητα με το που τελειώσει ο γύρος και ξεκινήσει ο νέος το temp_money
μηδενίζεται διότι δεν αποθηκεύεται παρα μόνο το money που λαμβάνει σε κάθε γύρο από το stronghold.
Το stronghold όπως αναφέρθηκε δίνει στην αρχή του γύρου money=5 αλλά δίνεται επιπλέον δυνατότητα στον παίχτη να πάρει χρήμα ίσο με 2 στο 
harvest το οποίο θα προσδωθεί στο temp_money.
Όταν γίνεται αγορά ενος holding και γίνεται έλεγχος για δημιουργία αλυσίδας(CheckChain), αν δεν φτιάχνεται αλυσίδα τότε δεν εκτυπώνεται κάποιο σχετικό μήνυμα. 
